          ...
          <div className="relative">
            ...
            {isProfileOpen ? (
              <div className="absolute right-0 mt-3 w-64 overflow-hidden rounded-xl border border-slate-200 bg-white p-2 shadow-soft dark:border-slate-800 dark:bg-slate-900">
                ...
                <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-left text-sm text-slate-600 transition hover:bg-slate-50 hover:text-primary dark:text-slate-300 dark:hover:bg-slate-800">
                ...
                <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-left text-sm text-danger transition hover:bg-red-50 dark:hover:bg-red-950/30">
